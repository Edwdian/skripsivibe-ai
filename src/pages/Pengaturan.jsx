...
import logoApp from "../assets/logo skripsivibe.png"; 
import {
  onAuthStateChanged,
  updateProfile,
  updatePassword,
...
const Pengaturan = () => {
  ...
  const handleSaveProfile = async (e) => {
    ...
    try {
      const user = auth.currentUser;
      if (user && user.displayName !== editFormData.nama)
      ...
      await setDoc(
        doc(db, "users", user.uid),
        {
          ...
          status: editFormData.status || "Mahasiswa",
        },
        { merge: true },
      );
  ...
  const inputClass =
    "w-full border border-gray-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 outline-none text-gray-800 text-sm transition-all bg-white";
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start max-w-7xl mx-auto w-full">
        <aside className="lg:col-span-1 sticky top-8">
          <div
            className="min-h-[380px] flex flex-col justify-center items-center text-center gap-5 rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(59,130,246,0.15)] hover:border-blue-300"
            style={{
          ...
          >
            <div className="relative mt-2">
              <div
                className="w-24 h-24 rounded-full flex items-center justify-center text-white text-3xl font-bold overflow-hidden shadow-lg"
                style={{
            ...
            <div>
              ...
              <span
                className="inline-block mt-3 px-4 py-1 text-xs font-bold rounded-full"
                style={{
            ...
            <p className="text-[10px] text-slate-300 mt-1">
              JPG, PNG, WebP • Maks 2MB • Min 10KB
            </p>

            <button
              onClick={openEditModal}
              className="w-full max-w-[200px] mx-auto block py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:opacity-90 hover:scale-[1.02]"
              style={{
                background: "linear-gradient(135deg, #3b82f6, #0ea5e9)",
        ...
        <main className="lg:col-span-2 flex flex-col gap-8">
          <section
            className="min-h-[380px] flex flex-col justify-center rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(59,130,246,0.15)] hover:border-blue-300"
            style={{
              background: "rgba(255,255,255,0.75)",
              border: "1px solid rgba(147,197,253,0.35)",
              backdropFilter: "blur(16px)",
          ...
          <section
            className="rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(59,130,246,0.15)] hover:border-blue-300"
            style={{
              background: "rgba(255,255,255,0.75)",
              border: "1px solid rgba(147,197,253,0.35)",
              backdropFilter: "blur(16px)",
          ...
          >
            ...
            <form onSubmit={handleSavePassword} className="space-y-4 mt-6">
              {[
                {
                  label: "Password Lama",
                  value: passwordLama,
              ...
              {passwordError && (
                <div
                  className="flex items-center gap-2 px-4 py-3 rounded-xl text-sm text-red-600 bg-red-50"
                  style={{ border: "1px solid rgba(252,165,165,0.5)" }}
                >
              ...
              {passwordSuccess && (
                <div
                  className="flex items-center gap-2 px-4 py-3 rounded-xl text-sm text-emerald-600 bg-emerald-50"
                  style={{ border: "1px solid rgba(110,231,183,0.5)" }}
                >
          ...
          >
            <div
              ...
              style={{ borderBottom: "1px solid rgba(219,234,254,0.8)" }}
            >
              <img
                src={logoApp}
                alt="SkripsiVibe Logo"
                className="w-14 h-14 object-contain rounded-xl p-1 bg-white shadow-sm shrink-0"
              />
              <div>
                <h3 className="text-lg font-bold text-slate-800">
                  SkripsiVibe AI
                ...
                <p className="text-xs text-slate-400 leading-relaxed mt-0.5">
                  Sistem Simulasi Sidang Skripsi Virtual Berbasis AI
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 mt-6">
              {[
                ...
                {
                  label: "Tim Developer",
                  value: "AI Engineer, Data Science, & Fullstack",
                },
              ].map((item, i) => (
                <div
                  key={i}
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          ...
          >
            <div
              className="px-6 py-4 flex justify-between items-center sticky top-0 bg-white z-10 rounded-t-3xl"
              style={{ borderBottom: "1px solid rgba(219,234,254,0.8)" }}
            >
            ...
            <form onSubmit={handleSaveProfile} className="p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-[10px] text-slate-300 mt-1 ml-1">
                ...
                <div>
                  ...
                  <select
                    value={editFormData.status || "Mahasiswa"}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
              ...
              <div
                ...
                style={{ borderTop: "1px solid rgba(219,234,254,0.8)" }}
              >
                <button
                  type="button"
                  onClick={() => setIsEditModalOpen(false)}
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl text-sm font-bold text-white disabled:opacity-70 transition-all hover:opacity-90"
                  style={{
                    background: "linear-gradient(135deg, #3b82f6, #0ea5e9)",
